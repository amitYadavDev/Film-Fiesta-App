...
android {
    namespace = "com.filmfiesta.themovieshow"
    compileSdk = 34

    // APK Name
    applicationVariants.all {
        val timestamp = SimpleDateFormat("yyyyMMddHHmm").format(Date())
        setProperty("archivesBaseName", "FilmFiesta-v${versionName}(${versionCode})-${timestamp}")
    }

    defaultConfig {
        applicationId = "com.filmfiesta.themovieshow"
        minSdk = 23
        targetSdk = 33
        versionCode = 125
        versionName = "1.25"
