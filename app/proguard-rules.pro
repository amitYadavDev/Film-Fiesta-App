...
-keepnames class com.filmfiesta.**
-keepclassmembers class * {
...
-keep class com.filmfiesta.themovieshow.data.paging.movie.MovieTrendingPagingSource
-keep class com.filmfiesta.themovieshow.data.paging.movie.MovieNowPlayingPagingSource
-keep class com.filmfiesta.themovieshow.data.paging.movie.MovieUpcomingPagingSource
# Paging 3
...
-keep class com.filmfiesta.themovieshow.model.** { *; }
...
-keep class com.filmfiesta.themovieshow.model.response.common.reviews.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.movie.cast.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.movie.detail.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.movie.discover.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.movie.nowplayingupcoming.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.movie.similar.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.movie.trending.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.movie.video.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.tvshow.cast.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.tvshow.detail.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.tvshow.discover.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.tvshow.popularairingtoday.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.tvshow.similar.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.tvshow.trending.* { *; }
-keep class com.filmfiesta.themovieshow.model.response.tvshow.video.* { *; }
